...
app = Flask(__name__)
app.config['SECRET_KEY'] = '22bce20289'
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://healthyheartdb_user:CxBhVpzYAMBbGpt1IiKmP7pH52SB2ILp@dpg-csjjsu3tq21c73ddr57g-a.oregon-postgres.render.com/healthyheartdb'
